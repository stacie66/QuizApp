...
import 'package:flashcards/src/features/flashcards/screens/flashcards_screen.dart';
import 'package:flashcards/src/features/decks/screens/decks_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Widget> _screens = [
    ...
    const DecksScreen(), // Add DecksScreen here
    const ChatScreen(),
    const ProfileScreen(),
  ];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
            icon: Icon(Icons.library_books_outlined), // Icon for Decks
